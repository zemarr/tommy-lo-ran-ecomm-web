          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div className="space-y-8">
              ...
              <div className="aspect-11/12 overflow-hidden bg-muted">
                <Image
                  src={collection.images[selectedImage] || "/placeholder.svg"}
                  alt={`${collection.name} - African menswear editorial photography`}
                  width={100}
                  height={300}
              ...
              <div className="flex gap-4">
                {collection.images.map((image, index) => (
                  <button
                    ...
                    aria-label={`View ${collection.name} image ${index + 1}`}
                  >
                    <Image
            ...
            <div className="lg:py-8">
              ...
              <div className="space-y-8">
                ...
                <div className="border-t border-border pt-8">
                  ...
                  <p className="text-sm text-muted-foreground">{collection.deliveryTime}</p>
                </div>
              </div>
            </div>
          </div>
